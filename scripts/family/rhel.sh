...
# $MNT/boot by customize-image.sh and this path is correct. GRUB_ENABLE_BLSCFG
# is true on Rocky, so the per-kernel cmdline lives in /boot/loader/entries and
# this regenerates the menu.
